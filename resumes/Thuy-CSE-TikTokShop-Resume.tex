...
\vspace{-9pt}
\begin{itemize}
  \item Explain technical concepts, such as bandwidth needs, signal strength, and device compatibility to help customers and partners make informed decisions.
  \item Support store operations by running diagnostics on devices, validating hardware issues, and contributing to technical troubleshooting while maintaining high-quality service delivery.
\end{itemize}

\textbf{Associate Full Stack Developer,} {Forge Tek Studios} -- Remote \hfill August 2025 -- Current 
\vspace{-9pt}
\begin{itemize}
  \item Built and deployed a production-ready full-stack React application, integrating external APIs (Steam, Fab Marketplace) to dynamically render real-time content and optimize performance.
  \item Optimized client-side rendering and data synchronization, reducing load overhead by 80\%—focusing on delivering a seamless UI for merchant-facing applications.
  \item Managed the full production release lifecycle, including build pipelines, environment configs, and hosting to deliver a fully operational site used by real customers.
  \item Designed and deployed serverless backends to keep costs low and systems flexible for high visitor traffic and varying business scenarios.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 
\vspace{-9pt}
\begin{itemize}
  \item Engineered a real-time, interaction-driven application using React and TensorFlow.js, processing live camera input and rendering responsive UI feedback for end-users.
  \item Developed secure and scalable RESTful APIs with Node.js to manage data flow and backend communication, using Redux Toolkit for efficient state management.
  \item Built and maintained a CI/CD pipeline using AWS Amplify, with automated testing via Jest and code quality enforcement through ESLint to ensure high-quality delivery.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Guided 40+ students in Java and SQL, providing technical consultation and explaining relational database design and system architecture concepts.
  \item Developed and maintained standardized learning materials and reference designs, enhancing assignment quality and technical understanding by 20\%.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Architected a data-flow pipeline connecting Python backend calculations to a live React dashboard, ensuring stable, low-latency API integration and real-time updates. 
  \item Leveraged JPMorgan Chase’s open-source library to generate live graphs, demonstrating best practices in data visualization and system integration.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Designed an event-driven architecture using SQS and EventBridge to process license plate data from S3, ensuring high-quality delivery and system scalability.
  \item Engineered integration solutions tailored to data processing scenarios, providing optimization recommendations for automated notification workflows.
\end{itemize}
...
\textbf{Skills:} RESTful API Design, Solution Architecture, API Debugging, Client Consultation, E-commerce Integration, Agile\\
