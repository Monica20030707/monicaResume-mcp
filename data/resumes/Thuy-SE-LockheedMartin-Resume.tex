...
\begin{itemize}
  ...
  \item Support store operations by running diagnostics on devices, managing inventory workflows using CRM, and contributing to sales goals with high integrity and transparency.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Guided 40+ students in Java and SQL, providing in-depth technical coaching on relational schema design, query optimization, and Java unit testing patterns.
...
\vspace{-9pt}
\begin{itemize}
  \item Designed digital and physical outreach materials using Canva to improve campus communication and informational design.
  \item Improved administrative efficiency by organizing digital records and streamlining visitor check-in processes.
  \item Utilized Microsoft Word, Excel and Outlook for efficient data management and accurate, prompt assistance in a fast-paced environment.
\end{itemize}
...
\begin{itemize}
  ...
  \item Implemented automated unit tests to ensure correctness and reliability of ratio calculation.
\end{itemize}
...
\begin{itemize}
  ...
  \item Verified system behavior through log inspection and iterative configuration changes to ensure stable and reliable operation.
\end{itemize}
...
\textbf{Skills:} CRM (MS Dynamics 365), Technical Writing, Lead Qualification, Sales Operations, Technical Communication, Marketing Support\\
\textbf{Tools:} Microsoft Office 365, Canva, React, Node.js, Linux, Raspberry Pi, JUnit, Javadoc, SQL, Excel, Outlook\\
