...
% summary section
\section*{Summary}
Results-driven Pre-Sales Engineer with a BS in Computer Science and a proven track record of high-velocity performance. Consistently ranked as the \#2 top-performing Sales Specialist at Verizon (Covington), achieving 130\% of sales targets through technical expertise and consultative solution-selling. Skilled in cloud security (AWS), event-driven architectures, and technical presentations, with a strong ability to translate complex security challenges into actionable business value.
...
\textbf{Skills:} Pre-Sales Engineering, Cybersecurity, Vulnerability Management, Cloud Security (AWS), Event-Driven Architecture, Technical Presentations\\
\textbf{Tools:} Tenable (Nessus), AWS (S3, SQS, SES, Rekognition), React, Node.js, Docker, Git, REST/GraphQL APIs\\
