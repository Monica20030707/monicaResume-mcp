...
% skills section
\section*{Skills}
\textbf{Languages:} JavaScript, TypeScript, Python, Java, Go, Kotlin, C++, SQL, Shell Scripting, Tailwind CSS\\
\textbf{Skills:} Technical Pre-sales, ROI/Business Value Analysis, Data Management, Technical Troubleshooting, AI Prompting (Skilled Prompter), RESTful APIs, CI/CD, Agile/Scrum\\
\textbf{Tools:} AWS (Rekognition, S3, SQS, EventBridge), Linux, DNS, React, Node.js, Serverless, Docker, Redux Toolkit, TensorFlow.js, CRM\\
