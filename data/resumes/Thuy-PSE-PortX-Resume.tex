...
\vspace{-9pt}
\begin{itemize}
  \item Identified and initiated partnerships with local business clients, serving as their primary technical point of contact and building long-term trust to drive growth.
  ...
  \item Explain technical concepts, such as signal propagation and network topology, to help customers make informed decisions and de-escalate complex technical issues.
\end{itemize}
...
\textbf{Skills:} Pre-Sales, Solution Design, Account Management, Relationship Building, API Integration, AWS (S3, SQS, EventBridge), Machine Learning, CI/CD\\
