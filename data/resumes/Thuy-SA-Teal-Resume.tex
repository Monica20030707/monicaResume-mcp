...
\vspace{-9pt}
\begin{itemize}
  \item Architected a modular React frontend with a serverless backend, leveraging custom hooks and context for efficient state management and third-party API integration.
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, Go, TypeScript, Java, JavaScript, SQL, YAML, LaTeX, Markdown, CSS\\
\textbf{Skills:} RESTful APIs (Postman), Technical Sales, Solution Design, Troubleshooting, CRM (Salesforce), Customer Discovery, Demos, Cloud-native Orchestration, CI/CD\\
\textbf{Tools:} AWS (S3, SQS, EventBridge), GitHub Actions, Git, React, Node.js, Serverless, Gemini (LLM), Tailwind CSS, Redux Toolkit\\
