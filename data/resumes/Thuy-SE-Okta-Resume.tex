...
\begin{itemize}
  ...
  \item Used JPMorgan Chase’s open-source library Perspective to generate a live, interactive graph for trader monitoring of real-time financial metrics.
...
\begin{itemize}
  ...
  \item Configured DNS services and network routing from scratch, diagnosing and resolving conflicts to ensure stable, zero-latency ad blocking.
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, TypeScript, JavaScript, Java, SQL, Shell Scripting, HTML/CSS\\
\textbf{Skills:} OAuth2, SAML, LDAP, DNS, RESTful APIs, Full-stack, Security (SSL/TLS, XSS), Whiteboarding\\
\textbf{Tools:} AWS, React, Node.js, Express, MCP, Docker, Git, Linux, Raspberry Pi, Jira\\
