...
\vspace{-9pt}
\begin{itemize}
  \item Conduct hardware diagnostics and firmware validation on mobile devices and networking equipment to ensure optimal performance.
...
\vspace{-9pt}
\begin{itemize}
  \item Improved administrative efficiency by organizing digital records and streamlining visitor check-in processes in a fast-paced environment.
  \item Managed campus security data and documentation using Microsoft Excel and advanced Outlook scheduling tools.
  \item Collaborated with public safety officers to manage campus-wide communication and emergency response logistics.
\end{itemize}
...
\begin{itemize}
  ...
  \item Mentored students on engineering principles as foundational career skills, managing office hours and group labs.
\end{itemize}
...
\textbf{Network-Wide Ad Blocker (Pi-hole)}{ - Raspberry Pi, Linux, Networking} \hfill \\
\vspace{-9pt}
\begin{itemize}
  ...
  \item Diagnosed and resolved network routing conflicts to ensure zero-latency ad blocking and stable operation.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, SQL (MySQL), Java, JavaScript, C++, HTML/CSS, TypeScript, Shell Scripting\\
\textbf{Skills:} Technical Troubleshooting, Hardware Diagnostics, Consultative Sales, CRM, Inventory Management\\
\textbf{Tools:} Microsoft Excel, Microsoft Outlook, Microsoft Word, Canva, Docker, React, AWS, Linux, Raspberry Pi\\
