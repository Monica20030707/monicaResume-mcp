...
\textbf{Skills:} Technical Sales, Solution Selling, Industrial Automation, Client Relations, Business Acumen, API Integration, Full-stack Development\\
\textbf{Tools:} AWS (S3, SQS, SES, Rekognition), CRM, React, Node.js, Docker, Git, Technical Troubleshooting\\
