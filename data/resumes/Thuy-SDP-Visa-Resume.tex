...
% skills section
\section*{Skills}
\textbf{Languages:} Python, SQL (MySQL), Java, JavaScript, C++, HTML/CSS, TypeScript\\
\textbf{Skills:} Sales Development, Client Relations, Data Analysis, Communication, CRM, Scrum Master\\
\textbf{Tools:} Microsoft Excel, Tableau, GenAI, AWS Cloud Services, Git, React, Docker\\
