...
\begin{itemize}
  ...
  \item Explain technical concepts, such as bandwidth needs, signal strength, and network topology to non-technical customers to help them make informed business decisions.
  \item Support store operations by running diagnostics on devices, validating hardware issues, and managing inventory workflows with high integrity and transparency.
\end{itemize}
...
\begin{itemize} 
  ...
  \item Achieved 90\%+ classification accuracy on the standard MNIST benchmark, verifying model correctness and deep understanding of machine learning fundamentals.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, TypeScript, JavaScript, SQL, C++, Java, HTML, CSS, LaTeX, YAML\\
\textbf{Skills:} Power Apps (Canvas/Model-Driven), Power Automate, AI Builder, Copilot Studio, RESTful APIs, Scrum/Agile, Client Relations, Business Acumen\\
\textbf{Tools:} Azure Infrastructure, AWS Cloud Services (Rekognition, S3, SQS), Git, GitHub Actions, Docker, React, Node.js, Figma\\
