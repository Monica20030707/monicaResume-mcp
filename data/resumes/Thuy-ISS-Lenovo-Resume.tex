...
\textbf{Skills:} CRM (MS Dynamics), Pipeline Management, Technical Troubleshooting, Consultative Selling, DNS, RESTful APIs\\
\textbf{Tools:} MS Office, LinkedIn Sales Navigator, ZoomInfo, Linux, Raspberry Pi, React, Node.js, AWS, TensorFlow.js\\
