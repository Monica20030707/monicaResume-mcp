...
\vspace{-9pt}
\begin{itemize}
  \item Reduced data visualization latency for trading metrics through the use of high-performance streaming libraries like Perspective.
  \item Architected a data-flow pipeline connecting Python backend calculations to a live React dashboard for real-time decision-making.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} SQL (MySQL), Python, Go, TypeScript, Java, JavaScript, HTML/CSS\\
\textbf{Skills:} Cloud Infrastructure (AWS/GCP), Database Strategy, Consultative Sales, Go-to-Market Strategy, RESTful APIs, Serverless Architecture\\
\textbf{Tools:} React, Node.js, AWS Cloud Services, CRM Tools, Docker, CI/CD, Event-driven Systems\\
