...
\begin{itemize}
  ...
  \item Implemented high-performance API integrations with third-party platforms like Steam and Fab Marketplace, optimizing data synchronization logic to reduce load overhead by 80\%.
  \item Managed the full production release lifecycle, delivering a production-ready application that handled high traffic volumes with minimal infrastructure costs.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 
\vspace{-9pt}
\begin{itemize}
  \item Integrated real-time machine learning models (MoveNet) with React to enable low-latency, gesture-based user interaction directly in the browser, enhancing engagement by 25\%.
  ...
  \item Automated testing and deployment processes via a custom CI/CD pipeline on AWS Amplify, ensuring consistent delivery and high code quality standards.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Architected a data-flow pipeline connecting Python backend calculations to a live React dashboard, optimizing real-time data streaming and state synchronization.
  \item Leveraged the Perspective library to build an intuitive, high-performance trading dashboard, increasing decision-making efficiency by 40\%.
...
\vspace{-9pt}
\begin{itemize}
  \item Architected an event-driven serverless pipeline on AWS, integrating Rekognition for image analysis and SQS for decoupled message processing to automate violation detection.
  \item Engineered Regex for geographic data filtering and identification of plate patterns, reducing manual processing time by over 90\%.
  \item Managed the end-to-end cloud infrastructure configuration to ensure cost-effective handling of bursty traffic patterns.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} JavaScript, TypeScript, Python, Java, SQL, HTML, CSS, C++, Go\\
\textbf{Skills:} RESTful APIs, Webhooks, Data Modeling, Full-stack Development, Technical Communication, Solution Selling\\
\textbf{Tools:} React, Node.js, Express.js, AWS (Rekognition, S3, SQS), TensorFlow.js, Low-code/No-code, Git, Docker\\
