...
% skills section
\section*{Skills}
\textbf{Languages:} Python, Go, TypeScript, Java, C++, JavaScript, Shell Scripting, MySQL, Tailwind CSS\\
\textbf{Skills:} Solution Design, Pre-Sales Support, Customer Relations, Network Topology, Troubleshooting, RESTful APIs, CI/CD, Agile/Scrum\\
\textbf{Tools:} React, Node.js, Serverless, AWS, Linux, DNS, CRM, Inventory Management, Perspective, TensorFlow.js\\
