...
\titleformat{\section}{\bfseries\large}{}{0pt}{}[\vspace{1pt}\titlerule\vspace{-65pt}]
...
\vspace{-9pt}
\begin{itemize}
  \item Built and deployed a production-ready full-stack application, integrating external APIs to dynamically render real-time content for users.
  \item Optimized client-side rendering and data synchronization, reducing load and ingestion overhead by 80\%—focusing on performance-sensitive updates.
  \item Managed the full production release lifecycle, including build pipelines, environment configs, and hosting to deliver fully operational solutions.
\end{itemize}

\textbf{Full Stack Developer Intern,} {METY Technology} -- Remote \hfill September 2024 -- June 2025 \\
\vspace{-9pt}
\begin{itemize}
  \item Developed secure and scalable RESTful APIs with Express.js and Node.js to manage complex data flow and backend communication.
  \item Architected a secure backend with a robust state management layer using Redux Toolkit to ensure application stability and performance.
...
\vspace{-9pt}
\begin{itemize}
  \item Engineered a custom network-layer security solution using Linux and Pi-hole to filter DNS traffic across all connected devices, enhancing overall network security.
  \item Diagnosed and resolved network routing conflicts to ensure zero-latency operation and improved page load speeds by 30\% through proactive blocking.
\end{itemize}
...
\begin{itemize}
  ...
  \item Automated the violation detection and notification workflow, reducing manual processing time by over 90\% while leveraging cloud scalability.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} JavaScript, TypeScript, Python, Java, Go, Shell Scripting, MySQL, HTML/CSS\\
\textbf{Skills:} Solutions Engineering, Technical Sales, Identity Management, API Integration, RESTful APIs, Cloud Computing (AWS), Network Security, CI/CD\\
\textbf{Tools:} React, Node.js, Express.js, Redux Toolkit, AWS (S3, SQS, SES), Linux, Pi-hole, Docker, Git, CRM\\
