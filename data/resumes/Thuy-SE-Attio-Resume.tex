...
\begin{itemize}
  ...
  \item Integrated Perspective to generate live, interactive graphs for trader monitoring, reducing data visualization latency.
  \item Implemented automated unit tests to ensure ratio calculation correctness and reliability.
\end{itemize}
...
\textbf{Skills:} RESTful APIs, API Integration, SaaS Concepts, JSON, Full-stack Development, Customer Success, Technical Troubleshooting\\
\textbf{Tools:} AWS (S3, SQS, EventBridge, SES, Rekognition, Amplify), React, Node.js, Express.js, Perspective, Docker, Git\\
