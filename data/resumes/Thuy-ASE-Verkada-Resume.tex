...
\begin{itemize}
  ...
  \item Automated the violation detection and notification workflow, reducing manual processing time by over 90\% through automated notice generation.
\end{itemize}
...
\begin{itemize}
  ...
  \item Used JPMorgan Chase’s open-source library Perspective to generate a live graph that displays a data feed in a clear and visually appealing way.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, TypeScript, JavaScript, SQL, Java, C++, React, Node.js, HTML, CSS\\
\textbf{Skills:} Technical Sales, Network Topology, Solutions Engineering, Technical Troubleshooting, Customer Relations, Consultative Selling, RESTful APIs, CI/CD\\
\textbf{Tools:} AWS (Rekognition, S3, SQS), Serverless, Redux Toolkit, Redux Thunk, Docker, Git, GitHub Actions, CRM, Perspective\\
