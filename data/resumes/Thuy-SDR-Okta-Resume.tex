...
\textbf{Skills:} Technical Discovery, Prospecting, Research, RESTful APIs, GraphQL, Full-stack, Scrum Master, Collaboration\\
\textbf{Tools:} Salesforce, Gen AI/ML, Kubernetes, React, React Native, Docker, Jira, AWS Cloud Services\\
