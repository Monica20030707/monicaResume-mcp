...
\vspace{-9pt}
\begin{itemize}
  \item Improved student success rates by 20\% through targeted feedback and supplemental instruction in Java best practices and relational database design.
  \item Managed office hours and group labs for 40+ students, adapting technical teaching methods to suit diverse backgrounds and learning speeds.
...
\begin{itemize}
  ...
  \item Automated the violation detection and notification workflow, reducing manual processing time by over 90\% through automated pattern matching and email triggers.
\end{itemize}
...
\begin{itemize}
  ...
  \item Used JPMorgan Chase’s open-source library Perspective to generate a live graph that displays a data feed in a clear and visually appealing way for traders to monitor.
\end{itemize}
...
% skills section
\section*{Skills}
\textbf{Languages:} Python, TypeScript, JavaScript, SQL, C++, Java, HTML, CSS, PHP, Golang, LaTeX\\
\textbf{Skills:} Technical Troubleshooting, Network Topology, Relationship-Based Sales, CRM (Salesforce), Consultative Selling, Solution Proposing, B2B Account Management\\
\textbf{Tools:} Salesforce, AWS Cloud Services (Rekognition, S3, SQS), React, Git, GitHub Actions, Docker, Figma, Node.js, Perspective\\
